...
import { getProductVariants } from '@/lib/actions/product-variant.action'
...
export default async function ProductDetails(props: {
  ...
  const selectedSizeStock = selectedVariant?.sizeStock.find(ss => ss.size === selectedSize)
